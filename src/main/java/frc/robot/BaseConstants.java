...
public final class BaseConstants {
  public static final class DriveConstants {
    ...
    public static final double kMaxAngularSpeedFactor = 3;
    ...
    // DRIVING SPARK MAX REVERSE STATE
    public static final boolean kFrontLeftReversed = false;
    public static final boolean kRearLeftReversed = true;
    public static final boolean kFrontRightReversed = false;
    public static final boolean kRearRightReversed = false;
  ...
  public static final class AutoConstants {
    ...
    // Path Planner Auto Config
    public static final HolonomicPathFollowerConfig pathFollowerConfig = new HolonomicPathFollowerConfig(
      new PIDConstants(5.0, 0.0, 0.0), // Translation PID constants
      new PIDConstants(5.0, 0.0, 0.0), // Rotation PID constants
      4.8, // Max module speed, in m/s defualt 4.8
