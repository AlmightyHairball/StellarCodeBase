...
public class DriveWithVisionLegacyAuto extends Command {
  ...
  public DriveWithVisionLegacyAuto(double xSpeed, double ySpeed, int aprilTagId, SwerveChassisSubsystem chassis) {
  ...
  public void execute() {
    ...
    double rot = MiscConstants.aimBot.calculate(vision.getAprilTagX(aprilTagId), 300);
