...
import frc.robot.RobotMechanisms.Crescendo.MechanismConstants.ClimberConstants;
import frc.robot.RobotMechanisms.Crescendo.MechanismConstants.ShooterConstants;
import frc.robot.RobotUtilities.MiscUtils;

// This subsystem is for controlling the climbers of the
// 2024 robot (Epic).

public class ClimberSubsystem extends SubsystemBase {
  
    // Declare motors, encoders, and PID controllers
    ...
    // Create some variables for position retention
